-- Step 2f: Calculate probabilities for Ñuñoa
-- Bounding box: approximately -70.62 to -70.58 (lon), -33.47 to -33.44 (lat)
-- ============================================================
...
WHERE ST_Intersects(n.geom, ST_MakeEnvelope(-70.62, -33.47, -70.58, -33.44, 4326));
...
WHERE ST_Intersects(a.geom, ST_MakeEnvelope(-70.62, -33.47, -70.58, -33.44, 4326));

SELECT 'Ñuñoa completed' as status;
