-- Step 2i: Calculate probabilities for Macul & La Florida
-- Bounding box: approximately -70.62 to -70.56 (lon), -33.52 to -33.48 (lat)
-- ============================================================
...
WHERE ST_Intersects(n.geom, ST_MakeEnvelope(-70.62, -33.52, -70.56, -33.48, 4326));
...
WHERE ST_Intersects(a.geom, ST_MakeEnvelope(-70.62, -33.52, -70.56, -33.48, 4326));

SELECT 'Macul & La Florida completed' as status;
