-- Step 2o: Calculate probabilities for Quilicura & Huechuraba
-- Bounding box: approximately -70.74 to -70.64 (lon), -33.38 to -33.32 (lat)
-- ============================================================
...
WHERE ST_Intersects(n.geom, ST_MakeEnvelope(-70.74, -33.38, -70.64, -33.32, 4326));
...
WHERE ST_Intersects(a.geom, ST_MakeEnvelope(-70.74, -33.38, -70.64, -33.32, 4326));

SELECT 'Quilicura & Huechuraba completed' as status;
