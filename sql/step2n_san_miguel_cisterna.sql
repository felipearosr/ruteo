-- Step 2n: Calculate probabilities for San Miguel & La Cisterna
-- Bounding box: approximately -70.68 to -70.62 (lon), -33.52 to -33.48 (lat)
-- ============================================================
...
WHERE ST_Intersects(n.geom, ST_MakeEnvelope(-70.68, -33.52, -70.62, -33.48, 4326));
...
WHERE ST_Intersects(a.geom, ST_MakeEnvelope(-70.68, -33.52, -70.62, -33.48, 4326));

SELECT 'San Miguel & La Cisterna completed' as status;
