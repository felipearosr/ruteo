-- Step 2j: Calculate probabilities for Recoleta & Independencia
-- Bounding box: approximately -70.66 to -70.62 (lon), -33.42 to -33.38 (lat)
-- ============================================================
...
WHERE ST_Intersects(n.geom, ST_MakeEnvelope(-70.66, -33.42, -70.62, -33.38, 4326));
...
WHERE ST_Intersects(a.geom, ST_MakeEnvelope(-70.66, -33.42, -70.62, -33.38, 4326));

SELECT 'Recoleta & Independencia completed' as status;
