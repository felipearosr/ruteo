-- Step 2b: Calculate probabilities for Lo Barnechea
-- Bounding box: approximately -70.52 to -70.46 (lon), -33.38 to -33.32 (lat)
-- ============================================================

-- Nodes in Lo Barnechea
...
WHERE ST_Intersects(n.geom, ST_MakeEnvelope(-70.52, -33.38, -70.46, -33.32, 4326));

-- Edges in Lo Barnechea
...
WHERE ST_Intersects(a.geom, ST_MakeEnvelope(-70.52, -33.38, -70.46, -33.32, 4326));

SELECT 'Lo Barnechea completed' as status;
