-- Step 2h: Calculate probabilities for Peñalolén
-- Bounding box: approximately -70.58 to -70.52 (lon), -33.50 to -33.46 (lat)
-- ============================================================
...
WHERE ST_Intersects(n.geom, ST_MakeEnvelope(-70.58, -33.50, -70.52, -33.46, 4326));
...
WHERE ST_Intersects(a.geom, ST_MakeEnvelope(-70.58, -33.50, -70.52, -33.46, 4326));

SELECT 'Peñalolén completed' as status;
