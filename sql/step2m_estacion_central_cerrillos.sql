-- Step 2m: Calculate probabilities for Estación Central & Cerrillos
-- Bounding box: approximately -70.72 to -70.66 (lon), -33.52 to -33.46 (lat)
-- ============================================================
...
WHERE ST_Intersects(n.geom, ST_MakeEnvelope(-70.72, -33.52, -70.66, -33.46, 4326));
...
WHERE ST_Intersects(a.geom, ST_MakeEnvelope(-70.72, -33.52, -70.66, -33.46, 4326));

SELECT 'Estación Central & Cerrillos completed' as status;
