-- Step 2d: Calculate probabilities for Vitacura
-- Bounding box: approximately -70.58 to -70.54 (lon), -33.40 to -33.36 (lat)
-- ============================================================
...
WHERE ST_Intersects(n.geom, ST_MakeEnvelope(-70.58, -33.40, -70.54, -33.36, 4326));
...
WHERE ST_Intersects(a.geom, ST_MakeEnvelope(-70.58, -33.40, -70.54, -33.36, 4326));

SELECT 'Vitacura completed' as status;
