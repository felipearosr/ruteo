-- Step 2c: Calculate probabilities for Providencia
-- Bounding box: approximately -70.62 to -70.58 (lon), -33.44 to -33.41 (lat)
-- ============================================================

-- Nodes in Providencia
...
WHERE ST_Intersects(n.geom, ST_MakeEnvelope(-70.62, -33.44, -70.58, -33.41, 4326));

-- Edges in Providencia
...
WHERE ST_Intersects(a.geom, ST_MakeEnvelope(-70.62, -33.44, -70.58, -33.41, 4326));

SELECT 'Providencia completed' as status;
