-- Step 2e: Calculate probabilities for Santiago Centro
-- Bounding box: approximately -70.66 to -70.63 (lon), -33.46 to -33.43 (lat)
-- ============================================================

-- Nodes in Santiago Centro
...
WHERE ST_Intersects(n.geom, ST_MakeEnvelope(-70.66, -33.46, -70.63, -33.43, 4326));

-- Edges in Santiago Centro
...
WHERE ST_Intersects(a.geom, ST_MakeEnvelope(-70.66, -33.46, -70.63, -33.43, 4326));

SELECT 'Santiago Centro completed' as status;
