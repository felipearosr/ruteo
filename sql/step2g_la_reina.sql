-- Step 2g: Calculate probabilities for La Reina
-- Bounding box: approximately -70.58 to -70.54 (lon), -33.46 to -33.42 (lat)
-- ============================================================
...
WHERE ST_Intersects(n.geom, ST_MakeEnvelope(-70.58, -33.46, -70.54, -33.42, 4326));
...
WHERE ST_Intersects(a.geom, ST_MakeEnvelope(-70.58, -33.46, -70.54, -33.42, 4326));

SELECT 'La Reina completed' as status;
