-- Step 2p: Calculate probabilities for La Granja & San Ramón
-- Bounding box: approximately -70.66 to -70.60 (lon), -33.56 to -33.52 (lat)
-- ============================================================
...
WHERE ST_Intersects(n.geom, ST_MakeEnvelope(-70.66, -33.56, -70.60, -33.52, 4326));
...
WHERE ST_Intersects(a.geom, ST_MakeEnvelope(-70.66, -33.56, -70.60, -33.52, 4326));

SELECT 'La Granja & San Ramón completed' as status;
